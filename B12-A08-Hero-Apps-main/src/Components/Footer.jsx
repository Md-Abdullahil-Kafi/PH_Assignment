...
import logo from "../assets/navbar-logo-icon.png";
      ...
      <Container>
        <div className="py-10 flex flex-col md:flex-row justify-between  gap-8">
          <div className="text-left">
            <NavLink to="/">
              <img src={logo} alt="AppManager" className="w-32" />
            </NavLink>
            <p className="mt-2 text-sm text-gray-400 max-w-xs">
              Crafting innovative apps to simplify and enhance your life. Join
              millions trusting us for productivity and creativity.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-1">
              <li>
                <a href="/about" className="hover:text-[#632EE3] transition">
                  About Us
                </a>
              </li>
              <li>
                <a href="/apps" className="hover:text-[#632EE3] transition">
                  Our Apps
                </a>
              </li>
              <li>
                <a href="/contact" className="hover:text-[#632EE3] transition">
                  Contact
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-1">
              <li>
                <a href="/help" className="hover:text-[#632EE3] transition">
                  Help Center
                </a>
              </li>
              <li>
                <a href="/faq" className="hover:text-[#632EE3] transition">
                  FAQ
                </a>
              </li>
              <li>
                <a href="/terms" className="hover:text-[#632EE3] transition">
                  Terms
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 py-4 text-center text-xs text-gray-500">
          <p>2025 AppManager. All rights reserved.</p>
        </div>
      </Container>
    </footer>
  );
