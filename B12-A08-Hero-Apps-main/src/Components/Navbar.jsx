      ...
      <Container>
        <div className="mx-auto flex justify-between items-center px-6 md:px-10 py-4">
          <div className="flex items-center gap-2">
            <NavLink to="/">
              <img src={logo} alt="AppManager" className="h-10" />
            </NavLink>
          </div>
          ...
          <ul className="hidden md:flex items-center gap-8 text-gray-700 font-medium">
            ...
            >
              <li className="hover:text-[#632EE3] hover:border-b-2 hover:border-[#632EE3] transition cursor-pointer font-semibold text-lg">
                Home
              </li>
            </NavLink>
            <NavLink
          ...
          <div className="hidden md:flex items-center gap-4">
            <a href="https://github.com/Md-Abdullahil-Kafi">
