...
const AppDetails = () => {
  ...
  if (!singleApp)
    return (
      <div>
        <AppNotFoundErrorPage></AppNotFoundErrorPage>
      </div>
    );
      ...
      <Container>
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 mt-20 pb-8 border-b-2 border-gray-200">
          ...
          <div className="md:flex-2 space-y-3">
            ...
            <p className="text-gray-500 border-b-2 border-gray-200 pb-4">
              Developed by{" "}
            ...
            <div>
              <button
                ...
                onClick={() => handleSaveApp(singleApp)}
                className={`bg-[#00D390] py-2 px-5 rounded-md text-white font-semibold text-xl mt-5 ${
                  disabledBtn
        ...
        <div className="h-[500px] mt-12 ">
          ...
          <ResponsiveContainer width="100%" height="100%">
            <BarChart layout="vertical" data={rating}>
